...
describe('xiaohongshu note', () => {
    ...
    it('returns note content as field/value rows for signed full URLs', async () => {
        ...
        expect(result).toEqual([
            { field: 'note_id', value: '69c131c9000000002800be4c' },
    ...
    it('extracts author_id from authorPageUrl when available', async () => {
        const page = createPageMock({
            loginWall: false, notFound: false,
            title: 'Note with author', desc: 'Content', author: 'Author',
            authorPageUrl: 'https://www.xiaohongshu.com/user/profile/69dc60a8000000003401a089?channel_type=web_note_detail_r10',
            likes: '10', collects: '5', comments: '3', tags: [],
        });
        const result = (await command.func(page, {
            'note-id': 'https://www.xiaohongshu.com/explore/69c131c9000000002800be4c?xsec_token=abc',
        }));
        const authorIdRow = result.find((r) => r.field === 'author_id');
        expect(authorIdRow.value).toBe('69dc60a8000000003401a089');
    });
